	...
	$.extend({
		tablesorter: new function() {
			...
			//function appendToTable(table,cache) {
			   // MKM Receives element we passed --------v
				...
				setTimeout(function() {
                    ...
                    // MKM Triggers the sortEnd event on the element we passed in
					...
					$headers.click(function(e) {
						...
						if(!this.sortDisabled && totalRows > 0) {
							...
							setTimeout(function() {
								...
								// MKM appendToTable($this[0],multisort($this[0],config.sortList,cache));
